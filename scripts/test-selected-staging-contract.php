...
namespace {
  ...
  foreach (['SelectedAssetRights', 'SelectedFinalizedSource', 'SelectedStagingContinuation', 'SiteStudioBuildPacketService', 'StagingReceiptService'] as $class) require $serviceRoot . $class . '.php';
