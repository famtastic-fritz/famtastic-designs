...
/**
 * @file
 * FAMtastic Designs — Drupal 11 headless backend settings.
 *
 ...
 *
 * - docker-compose (docker-compose.yml) injects DB_HOST/DB_PORT/DB_NAME/
 ...
 *   `database` relationship in .platform.app.yaml.
 *
