#!/usr/bin/env bash
#
# FAMtastic Designs — Phase 2 backend bootstrap.
#
...
# Keys MUST live outside the docroot (backend/web). backend/private/ is shared
...
echo "  4. Validate deployment configs: docker compose up --build (repository root)"
