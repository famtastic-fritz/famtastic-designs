...
/**
 * @file
 * Seeds FAMtastic Designs storefront content:
...
echo "== FAMtastic Designs — storefront seed ==\n";
...
$packages = [
  [
    ...
    'price' => '$199',
    'timeline' => 'Timing confirmed after intake',
    'badge' => 'quick_start',
    'sort' => 1,
    'hero_headline' => 'Get a Professional Website for $199',
    'hero_subheadline' => 'One focused page, one year of basic hosting, and a clear domain path.',
    'features' => [
      'One focused one-page business website',
      'Mobile-responsive design',
      'Lead capture form',
      'Foundational search and indexing setup',
      'First-year basic managed hosting',
      'Available new-domain registration for year one, or existing-domain connection',
    ],
  ...
  [
    ...
    'badge' => 'best_value',
    'sort' => 2,
    'hero_headline' => 'Launch or Upgrade a Business Website for $499',
    'hero_subheadline' => 'Up to five focused pages with lead capture, analytics, SEO foundations, and a structured launch path.',
    'features' => [
      'Up to five standard business pages',
      'Speed optimization',
      'SEO overhaul',
      'Lead routing',
      'Mobile-first rebuild',
    ],
    'best_for' => 'Businesses that need several standard pages for services, trust, customer questions, and lead capture—whether the site is new or replacing an old one.',
    'cta_text' => 'Start My Business Website — $499',
  ...
  [
    ...
    'badge' => 'none',
    'sort' => 3,
    'hero_headline' => 'A Fully Custom Website Foundation',
    'hero_subheadline' => 'Custom discovery, information architecture, visual design, implementation, and handoff for a distinctive business presence.',
    'features' => [
    ...
    'best_for' => 'Businesses whose brand, content structure, or customer journey needs original design and deeper discovery beyond the structured $499 bundle.',
  ...
  [
    ...
    'badge' => 'none',
    'sort' => 6,
    'hero_headline' => 'A Complete Paid-Campaign Landing System',
    'hero_subheadline' => 'A conversion-focused campaign destination with attribution, routing, measurement, and a follow-up path—not a basic business website.',
    'features' => [
      'Campaign strategy and single-focus conversion page',
      'A/B-test ready',
    ...
    'best_for' => 'Businesses with a defined offer and paid or targeted traffic that need a measurable campaign funnel. This is not the $199 first-website offer.',
    'cta_text' => 'Plan My Campaign System — $1,499',
    'cta_link' => '/contact?package=campaign-landing-page',
  ],
  [
