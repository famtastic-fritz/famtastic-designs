...
/**
 * Sends the one owner-authorized mobile video-review page notice through the
 ...
 *
 * Drush: drush php:script /private/path/send-owner-video-review-page.php [-- --send]
 */

use Drupal\famtastic_pipeline\Service\OutreachMailer;

const VIDEO_REVIEW_NOTICE_KEY = 'video-review-page-20260919-phone-v1';
const VIDEO_REVIEW_RECIPIENT = 'fritz.medine@gmail.com';
const VIDEO_REVIEW_SUBJECT = 'Your videos are ready to watch on your phone';
const VIDEO_REVIEW_BODY = "Hi Fritz,\n\nAll three latest videos are together on one page, ready to watch from your phone.\n\nWatch your videos:\nhttps://famtasticdesigns.com/video-review/\n\nThe page includes the walking continuation, the faster version two ad, and the clearly labeled local voice experiment. Tap a player for sound; captions and full-screen controls are included.\n\nAlways FAMtastic,\nShay";
