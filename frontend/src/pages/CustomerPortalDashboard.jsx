...
export default function CustomerPortalDashboard() {
  ...
  return <div className={`portal-app ${menu ? 'menu-open' : ''}`}>
    ...
    <main className="portal-main">
      ...
      {section === 'grow' && <section className="portal-grid three">{workspace.offers.map((offer) => <Panel key={offer.key} eyebrow="Recommended next step" title={offer.title} className="offer"><p>{offer.description}</p><small>Recommended from your current services and project stage.</small><a href={`/services`}>Explore options →</a></Panel>)}<Panel eyebrow="Not sure what you need?" title="Have FAMtastic handle it" className="lime"><p>Tell us the outcome you want. We’ll recommend the smallest useful next step.</p><button onClick={() => go('support')}>Describe my goal</button></Panel></section>}
