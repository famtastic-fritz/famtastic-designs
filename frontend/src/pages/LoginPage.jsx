...
export default function LoginPage() {
  ...
  return <section className="login-card" aria-labelledby="portal-heading">
    ...
    <form className="form" onSubmit={submit}>
      {mode === 'register' && <><div className="form__field"><label className="form__label" htmlFor="portal-name">Your name</label><input id="portal-name" className="form__input" name="name" required autoComplete="name" /></div><div className="form__field"><label className="form__label" htmlFor="portal-business">Business name <small>(optional)</small></label><input id="portal-business" className="form__input" name="business_name" autoComplete="organization" /></div></>}
      <div className="form__field"><label className="form__label" htmlFor="portal-email">Email</label><input id="portal-email" className="form__input" name="email" type="email" inputMode="email" required autoComplete="email" /></div>
