...
export default function LoginPage() {
  ...
  return <section className="login-card" aria-labelledby="portal-heading">
    ...
    <p className="login-card__lede">{searchParams.get('source')?.startsWith('public_') ? 'Continue your saved request with a detailed website brief and working design demos. Your account is free, and you will not be asked for payment to complete the brief.' : 'Manage your projects, purchases, support, hosting, domains, team, and next opportunities—all in one place.'}</p>
    ...
    <form className="form" onSubmit={submit}>
      {mode === 'register' && <input type="hidden" name="source" value={searchParams.get('source') || 'direct'} />}
