...
const DIRECTION_COPY = {
  ...
  b: { label: 'Wild', best: 'Best when the experience needs energy, identity, and a stronger reason to explore.', needs: 'The real creative lanes, priority pages, references, and the voice that feels like you.' },
  c: { label: 'OMG', best: 'Best when the site should feel like a flagship and make the organization hard to forget.', needs: 'Brand assets, consent-cleared stories, accessibility requirements, and the ambition for the build.' },
};
...
export default function PublicPreviewRoomPage() {
  ...
  return <main className="proof-share-page public-preview-room">
    ...
    <section className="proof-share-cta">
      <div><span>03 · Make a direction yours</span><h2>Give the studio the details that let it really wow you.</h2><p>Create a free FAMtastic Designs workspace with the same email to save this work, verify what is current, add the pages and assets that matter, and request a better-informed refinement.</p></div>
