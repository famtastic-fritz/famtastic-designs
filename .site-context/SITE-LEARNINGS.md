...
**Observation:** Postiz processes report online with zero restarts, but 34 Facebook/Instagram and eight YouTube records remain overdue. **Guidance:** Inspect current cause and prove only the newly approved exact campaign record. Neither an online process nor a QUEUE receipt proves publication. Preserve other campaigns and verify actual release URLs before expansion. The AlreadyBuilt checkpoint compares all 290 unrelated post records and distinguishes owner smoke scans from external customers; see `marketing/campaigns/alreadybuilt-fix-map-trial/RECEIPT-20260919.md`.
