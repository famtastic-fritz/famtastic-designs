...
From `v2/backend/` (drush is never run by the scaffold; run this manually):

```bash
drush config:import --partial --source=/Users/famtasticfritz/famtastic/sites/site-famtastic-designs/v2/backend/config/phase2
```
