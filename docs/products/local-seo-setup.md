...
stripe products create --name "Local SEO Setup" --description "Local search foundation and measurement setup."
stripe prices create --product <prod_id> --unit-price 29900 --currency usd
```
