...
- Added source-only private purchase companion forms: same-paid-order completion for17 and exact-scope, selection-bound one-time checkout for16, feature-gated OFF pending native/provider verification. Tests cover replay, access and honest payment/code states. No new live orders/payments or deployment.
