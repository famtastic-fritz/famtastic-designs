...
| Social publishing orchestration | **Schedule-proven 2026-09-03; still NOT publish-proven.** First real drafts ever created and scheduled: 4 drops (`cost-is-not-the-reason`) queued across FB/IG/X/TikTok/YouTube and all 4 read back as QUEUE (`scheduled_verified=4`, evidence `.artifacts/postiz-queue/cost-is-not-the-reason/1788436102/`). **No post has yet been confirmed live on any platform** — provider `PUBLISHED` state and on-account verification still outstanding. All five channels connection-proven 2026-08-25 (TikTok sandbox, daily re-auth, likely restricted from public posting until app audit). 17-day campaign remains unqueued beyond days 1–3, whose drafts carry stale 2026-08-23 dates. Sending depends on the operator workstation (Postiz on `127.0.0.1`); see `docs/marketing/CAMPAIGN_POSTING_ARCHITECTURE.md` | Approval, account-specific copy, media publishing, delivery verification, retry evidence, and campaign attribution |
