...
| Reusable page/component/part website recipes | Locally proven; Site Studio import unproven | Source-defined page recipes, stable section/component/field/slot identity, and a controlled four-page proof that changes only one hero-media binding while nine component instances and normalized page output remain identical; component swapping, multi-page conversion, production delivery, and Site Studio execution remain separate gates |
