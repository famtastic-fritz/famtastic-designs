...
| Social publishing orchestration | Provider-proven on Facebook; all five channels (IG/X/TikTok/YouTube) connection-proven 2026-08-25 (tokens verified live; TikTok sandbox w/ daily re-auth); draft→schedule executor locally proven 2026-08-25 (`publish-executor.php`, gate-protected, synthetic-only) | Approval, account-specific copy, media publishing, delivery verification, retry evidence, and campaign attribution |
