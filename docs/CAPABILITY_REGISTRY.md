...
| Social publishing orchestration | Provider-proven on Facebook; Instagram channel connection-proven 2026-08-24 (token verified via Graph, publish evidence pending first real post) | Approval, account-specific copy, media publishing, delivery verification, retry evidence, and campaign attribution |
