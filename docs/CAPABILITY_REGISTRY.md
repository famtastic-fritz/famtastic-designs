...
| Owner-gated three-direction website proofs | Locally proven | Safe/Wild/OMG generation, private staff review, authenticated selection, revision workflow, and a locally proven same-email public-preview claim that cannot auto-create a generic request/job before email verification (preview-registration isolation acceptance test) |
