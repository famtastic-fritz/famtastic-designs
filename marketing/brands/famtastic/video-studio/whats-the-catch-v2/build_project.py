...
def main():
    ...
    manifest={'schema':'famtastic.local-hyperframes-project.v1','id':'whats-the-catch-v2','title':'What’s the catch? — Version 2','entrypoint':'index.html','width':1920,'height':1080,'fps':30,'duration_seconds':duration,'files':files,'audio_master':{'path':'assets/narration.m4a','mode':'copy','start_seconds':0},'brand_logo':{'path':'assets/famtastic-designs-logo-v1.png','sha256':LOGO_SHA},'creator_credit_marker':'data-famtastic-creator-credit="v1"'}
