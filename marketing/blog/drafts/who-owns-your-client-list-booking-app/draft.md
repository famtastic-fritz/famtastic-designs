...
- **Identity** — names, and how many of them there are.
- **Contact details** — a phone number or an email address you could use to reach a person outside the app.
- **History** — what they booked, when, how often, what they paid, what you noted about them.
- **Reach** — whether you are permitted to contact them at all, and by what route.
...
You need somewhere of your own that collects a name and a way to reach someone — usually a short form on a page you own, asking for service, rough date, and contact detail, and nothing else, because every extra field costs you completed forms. [What a website contact form should ask](https://famtasticdesigns.com/blog/what-should-website-contact-form-ask) is a good starting shape.

You need an email address at your own address rather than a free one, so when you write to somebody the reply comes back to something you keep. [What a domain name is](https://famtasticdesigns.com/blog/what-is-a-domain-name) explains that part from the beginning.
...
What changes is that you stop having exactly one copy of the most valuable thing your business owns. Keep booking. Keep paying for introductions. Just make sure the relationships you have already earned exist somewhere that answers to you. That is the argument this series opens with in [why running a business on rented platforms costs revenue](https://famtasticdesigns.com/blog/why-running-business-on-gmail-and-linktree-costs-revenue), applied to the one asset that is genuinely hard to rebuild.

The starting point for a place of your own is the [Web Basics Bundle](https://famtasticdesigns.com/packages/199-quick-start): one focused landing-page website, a new domain registered for the first year or one you already own connected, and the first year of managed hosting. It is $199 for that year — about 55 cents a day — then $9.99 a month if you keep the hosting, plus the domain renewal.

The other options are on the [packages page](https://famtasticdesigns.com/packages). If you want a second opinion on which of the three questions above your own setup fails, [tell us about your business](https://famtasticdesigns.com/contact) and we will say so plainly.
