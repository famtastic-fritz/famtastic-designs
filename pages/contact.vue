        ...
        <div class="mt-8 grid gap-4 text-sm text-white/72">
          ...
          <div class="rounded-[24px] border border-white/8 bg-[#0D1210] p-5">
            ...
            <div class="mt-3 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <a :href="config.public.bookingLink" target="_blank" rel="noreferrer" class="rounded-full border border-white/12 px-4 py-2 text-sm text-white transition hover:border-[#79FF00]/40">Book a Strategy Call</a>
              <a :href="config.public.stripeAuditPaymentLink" target="_blank" rel="noreferrer" class="rounded-full border border-white/12 px-4 py-2 text-sm text-white transition hover:border-[#79FF00]/40">Pay Website Audit Deposit</a>
