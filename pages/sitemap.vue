...
useSeoMeta({ title: 'Sitemap | FAMtastic Designs', description: 'HTML sitemap for the FAMtastic Designs public marketing site.' });
</script>
...
<template>
  <div class="mx-auto max-w-4xl px-4 py-14 sm:px-6 lg:px-8">
    <div class="rounded-[28px] border border-white/8 bg-white/[0.03] p-8 lg:p-10">
      ...
      <h1 class="mt-3 text-4xl font-black text-white">Browse the public site routes.</h1>
