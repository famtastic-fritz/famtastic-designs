...
$receipt=['recipient'=>$recipients[$who],'status'=>'attempting','started_at'=>gmdate('c')];
...
try{
    if($who==='shay'){
        ...
        Illuminate\Support\Facades\Mail::html($html,fn($message)=>$message->to($recipients['fritz'])->subject('Tighten Up Your Locs — your independent admin is live'));
    }
